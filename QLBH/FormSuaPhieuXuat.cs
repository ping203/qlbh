...
namespace QLBH
{
    public partial class FormSuaPhieuXuat : Form
    {
        ...
        {
            gbxPhieuXuat.Visible = b;
            phieuxuatDataGridView.Visible = txtSearchPhieuXuat.Visible = !b;
        }

        private void btnSua_Click(object sender, EventArgs e)
        {
            if (Convert.ToString(phieuxuatDataGridView.CurrentRow.Cells["TrangThai"].Value) != "Lock")
            {
                reportViewerPhieuXuat.Visible = false;
                //
                XuLyConTro(false);
                ...
                MessageBox.Show("Phiếu xuất đã bị khóa, không thể chỉnh sửa");
        }
        ...
        private void CopyData()
        {
            ...
            HienGroupBox(true);
            //
            myIdPhieuXuat = Convert.ToInt32(phieuxuatDataGridView.CurrentRow.Cells["idphieuxuathang"].Value);
            dtpNgayLap.Value = Convert.ToDateTime(phieuxuatDataGridView.CurrentRow.Cells["NgayXuat"].Value);
            txtSoHieu.Text = Convert.ToString(phieuxuatDataGridView.CurrentRow.Cells["SoHieu"].Value);
            //
            myIdKhachHang = Convert.ToInt32(phieuxuatDataGridView.CurrentRow.Cells["IdKhachHang"].Value);
            txtTenKhachHang.Text = Convert.ToString(phieuxuatDataGridView.CurrentRow.Cells["TenKhachHang"].Value);
            txtDiaChi.Text = Convert.ToString(phieuxuatDataGridView.CurrentRow.Cells["DiaChiKhachHang"].Value);
            txtSDT.Text = Convert.ToString(phieuxuatDataGridView.CurrentRow.Cells["SDTKhachHang"].Value);
            txtPhaiThu.Text = Convert.ToString(phieuxuatDataGridView.CurrentRow.Cells["PhaiThu"].Value);
            ...
            //
            txtTienHang.Text = Convert.ToString(phieuxuatDataGridView.CurrentRow.Cells["TienHang"].Value);
            txtTienHang.Text = string.Format("{0:n0}", Double.Parse(txtTienHang.Text));
            txtGiamGia.Text = Convert.ToString(phieuxuatDataGridView.CurrentRow.Cells["GiamGia"].Value);
            txtGiamGia.Text = string.Format("{0:n0}", Double.Parse(txtGiamGia.Text));
            txtThanhToan.Text = Convert.ToString(phieuxuatDataGridView.CurrentRow.Cells["ThanhToan"].Value);
            txtThanhToan.Text = string.Format("{0:n0}", Double.Parse(txtThanhToan.Text));
            txtTongTien.Text = Convert.ToString(phieuxuatDataGridView.CurrentRow.Cells["TongTien"].Value);
            tamtinh = myPhaiThu - Convert.ToDecimal(txtTongTien.Text);
            ...
            //
            txtVBC.Text = Convert.ToString(phieuxuatDataGridView.CurrentRow.Cells["VBC"].Value);
            txtUser.Text = Convert.ToString(phieuxuatDataGridView.CurrentRow.Cells["User"].Value);
            myIdPhieuThu = Convert.ToInt32(phieuxuatDataGridView.CurrentRow.Cells["IdPhieuThu"].Value);
        ...
        private void btnXoa_Click(object sender, EventArgs e)
        {
            if (Convert.ToString(phieuxuatDataGridView.CurrentRow.Cells["TrangThai"].Value) != "Lock")
            {
                CopyData();
                string infor = "";
                infor += "Bạn có muốn xóa phiếu xuất này?" + "\n";
                infor += "\n";
                infor += "\n";
                if (MessageBox.Show(infor, Common.MessageCaption, MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) == System.Windows.Forms.DialogResult.Yes)
                {
                    ...
                    this.khachhangTableAdapter.FillBySearchId(this.qLBHDataSet.khachhang, myIdKhachHang);
                    myPhaiThu = Convert.ToDecimal(khachhangDataGridView.CurrentRow.Cells["PhaiThu1"].Value);
                    string sotien = Convert.ToString(phieuxuatDataGridView.CurrentRow.Cells["TongTien"].Value);
                    ...
                    // Xóa phiếu thu
                    myIdPhieuThu = Convert.ToInt32(phieuxuatDataGridView.CurrentRow.Cells["IdPhieuThu"].Value);
                    phieuthuTableAdapter.DeletePhieuThu(myIdPhieuThu);
                    phieuthuTableAdapter.Update(qLBHDataSet.phieuthu);
                    ...
                    phieuxuathangTableAdapter.Update(qLBHDataSet.phieuxuathang);
                    this.phieuxuathangctTableAdapter.FillBySearch(this.qLBHDataSet.phieuxuathangct, 0);
                }
                //
                {
                ...
                MessageBox.Show("Phiếu xuất đã bị khóa, không thể xóa");
        }
        ...
        private void ReadOnlyTextBox(bool b)
        {
            ...
            ctphieuxuatDataGridView.ReadOnly = !b;
            //
            btnThemCT.Enabled = btnXoaCT.Enabled = !b;
            //
        ...
        private void txtSearchPhieuXuat_TextChanged(object sender, EventArgs e)
        {
            this.phieuxuathangTableAdapter.FillBySearch(this.qLBHDataSet.phieuxuathang, "%" + txtSearchPhieuXuat.Text + "%");
        }
        ...
        private void phieuxuatDataGridView_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            reportViewerPhieuXuat.Visible = false;
        }
