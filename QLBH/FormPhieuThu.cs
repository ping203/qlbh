    ...
    public partial class FormPhieuThu : Form
    {
        ...
        private void btnXemPhieu_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                reportViewerPhieuThu.Visible = false;
                Form form = GetOpenedForm("FormSuaPhieuThu");
                if (form != null)
                    form.Activate();
                else
                {
                    form = new FormSuaPhieuThu();
                    form.Show();
        ...
        private void btnThem_Click(object sender, EventArgs e)
        {
            ...
            txtSoHieu.Text = "PT-" + a.Substring(2); 
            reportViewerPhieuThu.Visible = false;
        }
            ...
            {
                {
                    ...
                    myId = (int)phieuthuTableAdapter.FillBySearchIdSoHieu();
