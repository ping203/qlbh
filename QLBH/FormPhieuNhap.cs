...
namespace QLBH
{
    public partial class FormPhieuNhap : Form
    {
        ...
        {
            gbxPhieuNhap.Enabled = true;
            XuLyConTro(false);
            dataGridView_hide();
            ClearForNewRecord();
            //
            int sh = (int)phieunhaphangTableAdapter.FillBySearchIdMax();
            sh = sh + 100000001;
            string a = sh.ToString();
            txtSoHieu.Text = "PNK-" + a.Substring(2);
            //
            txtTenNhaCC.Select();
            myAdd = true;
            //
        ...
        private void BtnHuy_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    string infor = "";
                    infor += "Bạn có muốn hủy phiếu nhập này?" + "\n";
                    infor += "\n";
                    infor += "\n";
                    if (MessageBox.Show(infor, Common.MessageCaption, MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) == System.Windows.Forms.DialogResult.Yes)
                    {
                        ...
                        nhacungcapTableAdapter.UpdatePhaiTraNhaCC(
                                                                   myPhaiTra - Convert.ToDecimal(txtTongTien.Text),
                                                                    myIdNhaCC
                                                                    );
        ...
        private void btnThemCT_Click(object sender, EventArgs e)
        {
            if (RecordCheckInputThemCT() == true)
            {
                ...
                if (myAdd == true)
                {
                    phieunhaphangTableAdapter.InsertPhieuNhap(dtpNgayLap.Value,
                                                                txtSoHieu.Text,
                                                                myIdNhaCC,
                                                                txtTenNhaCC.Text,
                                                                txtDiaChi.Text,
                    ...
                    myIdPhieuNhap = (int)phieunhaphangTableAdapter.FillBySearchIdMax();
        ...
        private Boolean RecordCheckInput()
        {
            ...
            mySave = true;
            //this.phieunhaphangctTableAdapter.FillBySearch(this.qLBHDataSet.phieunhaphangct, myIdPhieuNhap);
            if (ctphieunhapDataGridView.RowCount < 1)
            {
                infor += "Lỗi nhập liệu" + "\n";
                infor += "----------------------------------" + "\n";
